...
public:
    ...
    // Set the X axis of the matrix (forward)
    void SetXAxis(Vector3 forward) const
    {
        // TODO Lab 01e
        //Vector3 xAxis;
        forward.x = mat[0][0];
    ...
    static Matrix4 CreateLookAt(const Vector3& eye, const Vector3& at, const Vector3& up)
    {
        ...
        return Matrix4(temp); // Creating an obj to world matrix AT the eye location
    }
    /* 380 CreateLookAt // world to object matrix (obj is eye) 
    * 	{
...
inline Vector4 Transform(const Vector4& vec, const Matrix4& mat)
{
    ...
    Vector4 retVal;
    retVal.x = vec.x * mat.mat[0][0] + vec.y * mat.mat[1][0] +
        vec.z * mat.mat[2][0] + mat.mat[3][0];
    retVal.y = vec.x * mat.mat[0][1] + vec.y * mat.mat[1][1] +
        vec.z * mat.mat[2][1] + mat.mat[3][1];
    retVal.z = vec.x * mat.mat[0][2] + vec.y * mat.mat[1][2] +
        vec.z * mat.mat[2][2] + mat.mat[3][2];
    retVal.w = vec.x * mat.mat[0][3] + vec.y * mat.mat[1][3] +
        vec.z * mat.mat[2][3] + mat.mat[3][3];
